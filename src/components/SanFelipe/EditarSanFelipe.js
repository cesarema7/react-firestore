    ...
    ref.get().then((doc) => {
      if (doc.exists) {
        ...
        this.setState({
          ...
          fechaS: solicitudsanfelipe.fechaS,
          personas: solicitudsanfelipe.personas,
          piloto: solicitudsanfelipe.piloto,
          vehiculo: solicitudsanfelipe.vehiculo,
          placa: solicitudsanfelipe.placa,
          detalle: solicitudsanfelipe.detalle,
          fechaR: solicitudsanfelipe.fechaR,
          autorizada: solicitudsanfelipe.autorizada
        });
      } else {
