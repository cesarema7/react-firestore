...
class CrearSanandres extends Component {
  ...
  constructor() {
    ...
    this.state = {
      distrito: 'SAN ANDRÉS VILLA SECA',
      cantidad: '',
      destino: '',
      fechaS: '',
      personas: '',
  ...
  onSubmit = (e) => {
    ...
    this.ref.add({
      ...
      window.location= "https://control-ambulancias-d69ec.firebaseapp.com/lista-solicitudes-san-andres-villa-seca"
    })
    .catch((error) => {
            ...
            <Grid className="mx-auto">
			  ...
			  <div>
                <h1 className="text-center font-weight-bold">
                  Solicitud de Combustible SAN ANDRÉS VILLA SECA
                </h1>
              ...
              <div className="mt-5 d-flex justify-content-center">
                <Fab variant="extended" color="secondary" href="https://control-ambulancias-d69ec.firebaseapp.com/lista-solicitudes-san-andres-villa-seca">
                  Cancelar  <CIcon /> 
                </Fab>
