...
class CrearSanCarlos extends Component {
  ...
  onSubmit = (e) => {
    ...
    this.ref.add({
      ...
      window.location = "https://control-ambulancias-d69ec.firebaseapp.com/lista-solicitudes-nuevo-san-carlos"
    })
    .catch((error) => {
          ...
          <Grid container spacing={3}>
            <Grid className="mx-auto">              
                ...
                <h1 className="text-center font-weight-bold">
                  Solicitud de Combustible NUEVO SAN CARLOS
                </h1>
              ...
              <div className="mt-5 d-flex justify-content-center">
                <Fab variant="extended" color="secondary" href="https://control-ambulancias-d69ec.firebaseapp.com/lista-solicitudes-nuevo-san-carlos">
                  Cancelar  <CIcon /> 
                </Fab>
