...
class CrearAsintal extends Component {
  ...
  onSubmit = (e) => {
    ...
    this.ref.add({
      ...
      window.location = "https://control-ambulancias-d69ec.firebaseapp.com/lista-solicitudes-el-asintal"      
    })
    .catch((error) => {
          ...
          <Grid container spacing={3}>
            <Grid className="mx-auto">            
                ...
                <h1 className="text-center font-weight-bold">
                  Solicitud de Combustible EL ASINTAL
                </h1>
